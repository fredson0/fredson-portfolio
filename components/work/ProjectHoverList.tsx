...
export default function ProjectHoverList({
  ...
  useLayoutEffect(() => {
    ...
    const hideModal = () => {
      ...
      gsap.utils
        .toArray<HTMLElement>(".project-row", list)
    ...
    list.addEventListener("mouseleave", hideModal);

    const rows = gsap.utils.toArray<HTMLElement>(".project-row", list);
    ...
    return () => {
      ...
      list.removeEventListener("mouseleave", hideModal);
